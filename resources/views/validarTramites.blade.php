    ...
    <body>
        ...
        <div class="container mt-2 mb-2">
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                  <h1 class="display-4 text-center">Administrar trámites</h1>
                  <p class="text-center">Aquí encontrarás la lista de las solicitudes de los trámites para que validarlos.</p>
                </div>
              </div>
        </div>
            <!-- Footer -->
